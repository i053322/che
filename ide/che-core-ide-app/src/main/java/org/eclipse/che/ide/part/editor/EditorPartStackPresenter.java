...
public class EditorPartStackPresenter extends PartStackPresenter implements EditorPartStack,
    ...
    public PartPresenter getActivePart() {
        boolean isActivePartNull = activePart == null;
        Log.error(getClass(), "**************** getActivePart is null? " + isActivePartNull);
        return activePart;
    }
    ...
    public void onTabClicked(@NotNull TabItem tab) {
        Log.error(getClass(), "**************** onTabClicked = active tab = ....");
    ...
    public void onTabClose(@NotNull TabItem tab) {
        ...
        eventBus.fireEvent(new FileEvent(((EditorTab) tab).getId(), ((EditorTab) tab).getFile(), CLOSE));
    }
